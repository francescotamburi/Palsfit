...
plt.axhline(y = 344,  color = g, linestyle = 'dashed')
...
plt.errorbar(df["Intensities"], df["Life-3"]*1000, yerr=df["Std Life-3"]*1000, linestyle="none", marker = "d", color=O, capsize=5)
