...
plt.errorbar(tau_5050["Sim Life-2"]-offset, tau_5050["Int-1"], yerr=tau_5050["Std Int-1"], linestyle="none", label="Tau 1", marker="s", color=P, capsize=5)
plt.errorbar(tau_5050["Sim Life-2"]-offset, tau_5050["Int-2"], yerr=tau_5050["Std Int-2"], linestyle="none", label="Tau 2", marker="s", color=O, capsize=5)
