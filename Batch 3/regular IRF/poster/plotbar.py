...
for dataset in plots:
	...
	plt.plot(x, data["220"][dataset[0]][dataset[1]], color=P, label="220ps", marker="d", linestyle="dotted")
	plt.xticks(x,x)
	plt.xlabel("Lifetime separation $\\tau_2-\\tau_1$ [ps]")
	plt.ylabel("Fitted $I_1$ - Simulated $I_1$ [\\%]")
	
	plt.legend(title="$\\tau_1$")
