...
ax2.errorbar(df["Intensities"], df["Life-1"]*1000, yerr=df["Std Life-1"]*1000, linestyle="dashed" , marker = "d", color=O, capsize=5, label="$\\tau_1$")
ax2.errorbar(df["Intensities"], df["Life-2"]*1000, yerr=df["Std Life-2"]*1000, linestyle="dashed" , marker = "s", color=G, capsize=5, label="$\\tau_2$")
ax2.errorbar(df["Intensities"], df["Life-3"]*1000, yerr=df["Std Life-3"]*1000, linestyle="dashdot", marker = ".", color=P, capsize=5, label="$\\tau_3$")
...
ax2.axhline(y = 355,  color = dg, linestyle = 'dashed')
ax2.axhline(y = 444,  color = dg, linestyle = 'dashed')
...
plt.errorbar(df["Intensities"], df["Int-1"], yerr=df["Std Int-1"], linestyle="none" , marker = "d", color=O, capsize=5, label="$I_1$")
plt.errorbar(df["Intensities"], df["Int-2"], yerr=df["Std Int-2"], linestyle="none" , marker = "s", color=G, capsize=5, label="$I_2$")
plt.legend()
