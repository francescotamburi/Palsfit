...
#plt.errorbar(tau_5050["Sim Life-2"], tau_5050["Life-2"]*1000-tau_5050["Sim Life-2"], yerr=tau_5050["Std Life-2"]*1000, linestyle="none", label="50-50", marker = "x", color=R, capsize=5)
#plt.errorbar(tau_5050["Sim Life-2"]-offset, tau_5050["Int-1"], yerr=tau_5050["Std Int-1"], linestyle="none", label="Tau 1", marker="x", color=P, capsize=5)
#plt.errorbar(tau_5050["Sim Life-2"]-offset, tau_5050["Int-2"], yerr=tau_5050["Std Int-2"], linestyle="none", label="Tau 2", marker="x", color=O, capsize=5)

tau_8020 = df[df["Sim Int-1"]==80]
#plt.errorbar(tau_2080["Sim Life-2"]+offset, tau_8020["Life-1"]*1000, yerr=tau_8020["Std Life-1"]*1000, linestyle="none", label="80-20", marker = "d", color=G, capsize=5)
#plt.errorbar(tau_8020["Sim Life-2"]+1, tau_8020["Life-2"]*1000-tau_8020["Sim Life-2"], yerr=tau_8020["Std Life-2"]*1000, linestyle="none", label="80-20", marker = "d", color=G, capsize=5)
